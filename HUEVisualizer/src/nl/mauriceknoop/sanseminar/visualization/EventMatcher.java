 ...
 */
public abstract class EventMatcher implements IEventMatcher{
    ...
    /**
     * <p>
     * Indicates which Events are referenced by this Event. In practice this should mean that for every EventMatcher
     * {@code eventMatcher} that is returned by this method, it should hold that if
     * {@code eventMatcher.{@link #matches(Event)}} is true, then {@code this.{@link #matches(Event)}} should be
     * true as well. In other words, for each of the returned EventMatcher: if any of them matches, this
     * EventMatcher matches as well.
     * </p>
     * <p>
     * Typically if {@link #matches(Event)} is overridden, this method should be too. This also holds the other way
     * around.
     * </p>
     * @return All EventMatchers that are referenced by this EventMatcher. Return {@code null} to indicate that no
     * EventMatchers are referenced.
     */
